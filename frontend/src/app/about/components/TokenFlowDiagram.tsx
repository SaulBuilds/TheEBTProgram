...
const flowSteps = [
  {
    ...
    details: [
      ...
      '200K-20M $SNAP based on contribution',
    ],
    from: 'User',
    to: 'EBTProgram',
    asset: '0.02-2 ETH',
  ...
  },
  {
    ...
    description: '$SNAP tokens minted directly to the token-bound account based on your contribution',
    details: [
      '200K-20M $SNAP initial allocation',
  ...
  },
  {
    ...
    description: 'NFT holders receive monthly $SNAP stipends based on activity',
    details: [
      '20K-20M $SNAP per month',
    ...
    <div className="space-y-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto mb-6">
          Watch how ETH, NFTs, and $SNAP tokens flow through the system.
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-gray-900 border border-gray-800 rounded-lg text-center">
          ...
          <div className="text-sm text-gray-500">Max $SNAP Supply</div>
        </div>
        <div className="p-4 bg-gray-900 border border-gray-800 rounded-lg text-center">
