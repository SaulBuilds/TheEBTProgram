...
const mockLeaderboardData: Record<LeaderboardCategory, LeaderboardEntry[]> = {
  total: [
    { rank: 1, userId: 'user1', username: 'breadlord420', profilePic: '', value: 850000, valueLabel: '$SNAP', change: 2, badges: ['Crown', 'OG'] },
    { rank: 2, userId: 'user2', username: 'welfareQueen', profilePic: '', value: 720000, valueLabel: '$SNAP', change: 0, badges: ['Verified'] },
    { rank: 3, userId: 'user3', username: 'foodstampKing', profilePic: '', value: 680000, valueLabel: '$SNAP', change: 1, badges: [] },
    { rank: 4, userId: 'user4', username: 'degenChef', profilePic: '', value: 540000, valueLabel: '$SNAP', change: -1, badges: ['Streak'] },
    { rank: 5, userId: 'user5', username: 'cryptoHungry', profilePic: '', value: 420000, valueLabel: '$SNAP', change: 3, badges: [] },
    { rank: 6, userId: 'user6', username: 'breadlineVIP', profilePic: '', value: 380000, valueLabel: '$SNAP', change: -2, badges: [] },
    { rank: 7, userId: 'user7', username: 'govtCheeseEnjoyer', profilePic: '', value: 350000, valueLabel: '$SNAP', change: 0, badges: [] },
    { rank: 8, userId: 'user8', username: 'ramenLord', profilePic: '', value: 320000, valueLabel: '$SNAP', change: 1, badges: [] },
    { rank: 9, userId: 'user9', username: 'starvingArtist', profilePic: '', value: 280000, valueLabel: '$SNAP', change: 0, badges: ['OG'] },
    { rank: 10, userId: 'user10', username: 'hungerGamer', profilePic: '', value: 250000, valueLabel: '$SNAP', change: -1, badges: [] },
  ],
  weekly: [
    { rank: 1, userId: 'user5', username: 'cryptoHungry', profilePic: '', value: 45000, valueLabel: '$SNAP this week', change: 5, badges: ['Hot'] },
    { rank: 2, userId: 'user1', username: 'breadlord420', profilePic: '', value: 38000, valueLabel: '$SNAP this week', change: 0, badges: ['Crown'] },
    { rank: 3, userId: 'user7', username: 'govtCheeseEnjoyer', profilePic: '', value: 32000, valueLabel: '$SNAP this week', change: 2, badges: [] },
  ],
  streaks: [
